...
void GPIO_Init(void)
{
		...
		LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOA);	/* Enable GPIOA */
		LL_AHB1_GRP1_EnableClock(LL_AHB1_GRP1_PERIPH_GPIOB);	/* Enable GPIOB */
...
void _1293d_config()
{
	LL_GPIO_InitTypeDef d_initstruct;																		/*declare struct for IC config */
...
void TIM4_Base_Config(void)
{
	...
	timbase_initstructure.Autoreload = 100;
	timbase_initstructure.Prescaler = 32000;
...
void TIM_OC_GPIO_Config(void)
{
	...
	gpio_initstructure.Pin = MOTOR_H_PIN;
	gpio_initstructure.Pull = LL_GPIO_PULL_NO;
	gpio_initstructure.Speed = LL_GPIO_SPEED_FREQ_VERY_HIGH;
	LL_GPIO_Init(MOTOR_H_PORT,&gpio_initstructure);
...
void TIM_OC_Config(void)
{
	...
	LL_TIM_OC_Init(TIM4, LL_TIM_CHANNEL_CH2, &tim_oc_initstructure);
